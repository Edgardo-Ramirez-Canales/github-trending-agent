...
export default function LoginScreen({ onLogin, error, cargando }) {
  return (
    <div className="min-h-dvh flex items-center justify-center p-6">
      <div className="relative w-full max-w-md overflow-hidden rounded-xl border border-white/10 bg-[#0d111a]/86 p-8 text-center shadow-2xl shadow-black/40 backdrop-blur">
        ...
        <div className="pointer-events-none absolute -left-20 top-10 h-px w-64 rotate-[-42deg] bg-[#007ACC]/70 shadow-[0_0_18px_rgba(0,122,204,0.9)]" />
        ...
        <div className="relative mx-auto mb-5 mt-6 flex h-11 w-11 items-center justify-center rounded-lg border border-[#007ACC]/35 bg-[#007ACC]/15 text-[#7cc7ff] shadow-[0_0_32px_rgba(0,122,204,0.22)]">
        ...
        <h1 className="relative text-2xl font-semibold text-slate-50">
          GitHub Trending Agent
        </h1>
        <p className="relative mt-2 text-xs font-medium uppercase tracking-[0.28em] text-slate-500">
        ...
        <p className="relative mt-6 text-xs leading-5 text-slate-500">
